variable "security_group_ingress" {
  ...
  default = [
    {
      protocol       = "TCP"
      description    = "разрешить входящий GitLab Container Registry"
    ...
    {
      protocol       = "TCP"
      description    = "разрешить входящий http для Nexus"
      v4_cidr_blocks = ["0.0.0.0/0"]
      port           = 8081
    },
    {
      protocol       = "TCP"
      description    = "разрешить входящий http для Sonarqube"
      v4_cidr_blocks = ["0.0.0.0/0"]
      port           = 9000
    },
  ]
