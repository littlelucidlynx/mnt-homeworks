...
- Базовые метрики центрального процессора позволят выявить аномальную загрузку процессора, а в связке с метриками дисковой подсистемы позволят определить узкое место:
